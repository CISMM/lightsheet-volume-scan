function [scan_x_arr, scan_y_arr] = initialization_scan_extra(mir_start, mir_end, etl_start ...
...
step = abs((mir_start-mir_end))/num_scan;
num_scan_extra = num_scan + extra_pts_mir_start + extra_pts_mir_end;
mir_start_extra = mir_start - step*extra_pts_mir_start;
mir_end_extra = mir_end + step*extra_pts_mir_end;
scan_x_arr = linspace(mir_start_extra, mir_end_extra, num_scan_extra);
